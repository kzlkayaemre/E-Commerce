          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Kullanıcı Ayarları(Düzenleme) <small>,
                  ...
                  <div class="x_content">
                    ...
                    <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <?php
                      // kayıt zamanını çekmek için explode fonksiyonu ile zamanı parçaladık.
                      //" ": nereden itibaren ayırmak istiyorsun ,'den sonrası da neyi ayırmak istiyorsun.
                      //ayrıca explode fonk. zaman için dizi oluşturdu ör:$zaman[1]; dersek saati alır.
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <!--direkt kullanici çek değişkeni ile zamanı çekersek gg/yy/ şeklinde gelir düzenleyemeyiz.-->
                          <input type="date" id="first-name" disabled="" name=" kullanici_tc" value="<?php echo $zaman[0]; ?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="heart" class="form-control col-md-7 col-xs-12" name=" kullanici_mail"required="required" >

                            <!-- Kullanıcı durum kısmında select kutucuğu oluşturduk db'de durum 1 ise aktif
                            0 ise pasif olacak -->  


                            <!--option value 1 ise kullanıcı durumu 1'dir selected yap. -->
                            <option value="1" <?php echo $kullanicicek['kullanici_durum']== '1' ? 'selected=""' : ''; ?> >Aktif</option>

                            <!--option value 0 ise kullanıcı durumu 0'dir selected yap. -->
                            <option value="0" <?php if( $kullanicicek['kullanici_durum']== 0) {echo 'selected=""';} ?> >Pasif</option>

                            <!--
                              yukarıdaki yöntemin aynısı
                              2. yöntem; fakat select'lerin çok olduğu durumlarda kullanımı zorlaşacaktır.
                    ...
                    <!-- kullanıcı_id yi aldık hidden ile gizledik güncelle dediğimiz zaman
                      işlem.php'ye gidecek ve orada yakalayacağız-->
