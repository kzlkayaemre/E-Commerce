...
//$say değişkeni ile saydırdığımız satırın 0 olması yani dolu olmaması ile 
//kullanıcıyı tekrar login ekranına yönlendiriyoruz.
//farklı browserlerdan girilen link ile siteye giriş yapılmaması.
if ($say==0) {
...
<html lang="en">
  <head>
    ...
    <title>Emre Kızılkaya | e-ticaret</title>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="logout.php"><i class="fa fa-sign-out pull-right"></i> Güvenli Çıkıs</a></li>
                  </ul>
                </li>
